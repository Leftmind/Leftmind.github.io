...
const DialogBox = (props) => {
  ...
  const {
    ...
    handleCloseDialog,
    handleBannerClick,
    dialogObj: { text, img, descriptionText, completed },
  } = props
  return (
    <Dialog
      classes={{
    ...
    >
      ...
      <DialogContent
        className={classes.dialogBanner}
        style={{ backgroundColor: completed ? '#96CB3C' : '#313230' }}
      ...
      >
        {completed ? (
          ...
          >
            <CheckCircle
              className={classes.dialogBannerCheck}
              fontSize="large"
            />
            <DialogContentText
              display="inline"
              className={classes.DialogBannerText}
              variant="h6"
            >
              Jag har uppnåt detta mål!
            </DialogContentText>
          </Box>
        ) : (
          <Box
          ...
          >
            ...
            <DialogContentText
              ...
              variant="h6"
            >
              Klicka här om du har uppnåt målet
            </DialogContentText>
      ...
      setCardData([
        {
          ...
          img: firstCustomerImg,
          completed: challenges[0].completed,
          descriptionText: challenges[0].descriptionText,
        },
        {
          id: 1,
          text: challenges[1].text,
          img: firstHundredKronor,
          completed: challenges[1].completed,
          descriptionText: challenges[1].descriptionText,
        },
        {
          id: 2,
          text: challenges[2].text,
          img: cooperation,
          completed: challenges[2].completed,
          descriptionText: challenges[2].descriptionText,
        },
        {
          id: 3,
          text: challenges[3].text,
          img: twoKpoints,
          completed: challenges[3].completed,
          descriptionText: challenges[3].descriptionText,
        },
        {
          id: 4,
          text: challenges[4].text,
          img: null,
          completed: challenges[4].completed,
          descriptionText: challenges[4].descriptionText,
        },
        {
          id: 5,
          text: challenges[5].text,
          img: null,
          completed: challenges[5].completed,
          descriptionText: challenges[5].descriptionText,
        },
        {
          id: 6,
          text: challenges[6].text,
          img: null,
          completed: challenges[6].completed,
          descriptionText: challenges[6].descriptionText,
        },
        {
          id: 7,
          text: challenges[7].text,
          img: null,
          completed: challenges[7].completed,
          descriptionText: challenges[7].descriptionText,
        },
      ])
    })()
  }, [usedUser])

  const handleCardPress = (ind) =>
    setDialogData({
      open: true,
      dialogObj: cardData.find((el) => el.id === ind),
    })
    ...
    <>
                ...
                >
                  <CardContent className={classes.cardContentContainer}>
                    ...
                    <Typography
                      component="h2"
                      align="center"
                      className={classes.utmaningCardTitle}
                    >
                      {text}
                    </Typography>
      ...
      {dialogData.open && (
        <DialogBox
          ...
          handleBannerClick={async () =>
            handleBannerClick(dialogData.dialogObj.id)
          }
          {...dialogData}
        />
      )}
