...
function CreateCompany(props) {
    ...
    async function handleSubmit(event) {
        ...
        let firestoreId = generateUniqueFirestoreId();

        await firebase.firestore().collection('companies').doc(firestoreId).set({
            bio: newUserData.bio,
    ...
    async function addCompanyToAccount(userData, firestoreId){
        ...
        await firebase.firestore().collection('users').doc(user.uid).set({
            companies: [{ companyId: firestoreId, companyName: userData.companyName }],
          },
          { merge: true });
